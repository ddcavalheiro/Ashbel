...
{
    public class StatusPessoaConfiguration : IEntityTypeConfiguration<StatusPessoaModel>
    {
        public void Configure(EntityTypeBuilder<StatusPessoaModel> builder)
        {
            builder.ToTable("StatusPessoa").HasKey(o => o.Id).HasName("Id");
